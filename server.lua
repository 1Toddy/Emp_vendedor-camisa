...
emP = {}
job = {}
Tunnel.bindInterface("emp_vendedor-camisa",emP)
Tunnel.bindInterface("emp_vendedor-camisa",job)
----------------------------------------------------------------------------------
------- PEGAR FERRAMENTAS 
----------------------------------------------------------------------------------
...
------- COLOCAR ROUPA
----------------------------------------------------------------------------------
RegisterServerEvent('emp_vendedor-camisa:roupa')
AddEventHandler('emp_vendedor-camisa:roupa', function()
	local source = source
	local user_id = vRP.getUserId(source)
    if user_id then
